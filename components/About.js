...
export default function About() {
    return (
        <div className='py-6 px-5 pt-5 pb-3 mb-5 -mr-14 md:mr-0 bg-pattern flex flex-col items-center justify-between'>
            ...
            <div className='flex flex-row items-center text-center justify-between'>
                ...
                <h2 className='text-white my-3 text-6xl text-center'>About The Lost Bulls</h2>
