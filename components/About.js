...
export default function About() {
    return (
        <div className='py-6 px-1 pt-5 pb-3 mb-5 w-full bg-transparent md:bg-pattern flex flex-col'>
            ...
            <div className='about px-2 md:px-16 mt-3 py-8 text-white text-sm text-center bg-gray-900 rounded-md border-4 border-lime'>
                ...
                <p className="mb-3">When you invest in TLB, you are not only investing in a unique digital art piece with symbolism connected to it. You are also taking part in all of its beneficial features.</p>
            </div>
        </div>
    )
}
