        ...
        <div id='benefits' className='bg-pattern -mr-14 md:mr-0 pt-5 pb-12 px-8 flex flex-col justify-between'>
            ...
            <div className='px-4 py-8 text-white text-sm bg-gray-900 rounded-md border-4 border-lime'>
                ...
                <ul className='px-8 pt-8 list-disc'>
                    ...
                    <li className='px-8 list-disc' >(Example: the royalty balance is $100,000. $25,000 will be placed in the community fund to be distributed as staking rewards. There are 1,000 TLB NFTs being staked. A TLB NFT staked for 1 month will be rewarded $5 [($25,000/1000) x .2)])</li>
                    <ul>
